...
Key game events also reach a player **out of band** through the browser's push service (the external out-neighbour above), so a backgrounded phone still surfaces them.
